...
namespace GerenciadorOVNI
{
    public partial class Painel : Form
    {
        ...
        public Painel(BibliotecaOVNI.OVNI ovni)
        {
            ...
            //assim q a pagina for construida, chamar os dados:
            AtualizarDados();

            //adicionar os acrescentos dos planetas // popular CMB
            cmbPlanetas.DataSource = BibliotecaOVNI.OVNI.PlanetasValidos;
        }

        //fazer um metodo para atualizar os dados:
        ...
        private void btnLigar_Click(object sender, EventArgs e)
        {
            ...
            AtualizarDados(); //Atualizar dados sempre depois de cada evento
        }
